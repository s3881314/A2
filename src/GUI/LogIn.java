...
public class LogIn {
    ...
    private void CheckLogIn() {
        ...
        if (Position.getText().isEmpty() &&Username.getText().isEmpty() && Password.getText().isEmpty()) {
            ...
            if (Position.getText().equals("Doctor")) {
                try {
                    boolean login = false;
                    File myObj = new File("F:\\Textbook\\MasterOfIT\\COSC1295 Advanced Programming\\Assignment\\Assignment2\\A2_1\\src\\Archive\\DoctorList.txt");
    ...
    public void LogInFile(String u, String p){
        ...
        try {
            ...
            FileWriter fw = new FileWriter("F:\\Textbook\\MasterOfIT\\COSC1295 Advanced Programming\\Assignment\\Assignment2\\A2_1\\src\\Archive/LogIn.txt");
